                ...
                <div class="about__content">
                    <div class="about__content-wrapper">
                        ...
                        <div class="about__info">
                            <p>System Information by Me (in progress).</p>
                            <p>Front-End Development at CPC.</p>
                        </div>
                    </div>
                    <div class="about__content-wrapper">
                        <h5 class="about__title">Projects...</h5>
                        <div class="about__info">
                            <p>I was a scholarship holder for an extension project at college where we developed a web system for risk classification using vue.js.</p>
                        </div>
                    </div>
                    <div class="about__content-wrapper">
